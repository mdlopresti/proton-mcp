...
def register_tools(mcp: FastMCP, config: Config) -> None:
    ...
    def bulk_move_emails(
        email_ids: str, target_folder: str, source_folder: str = "INBOX"
    ) -> str:
    ...
    @mcp.tool()
    def bulk_mark_emails_as_read(
        email_ids: str, mailbox: str = "INBOX", mark_read: bool = True
    ) -> str:
    ...
    @mcp.tool()
    def bulk_mark_emails_as_important(
        email_ids: str, mailbox: str = "INBOX", mark_important: bool = True
    ) -> str:
    ...
    def bulk_delete_emails(
        email_ids: str, mailbox: str = "INBOX", permanent: bool = False
    ) -> str:
    ...
    def move_email_to_folder(
        email_id: str, target_folder: str, source_folder: str = "INBOX"
    ) -> str:
